...
export const entryFields: Record<
  Exclude<SectionType, 'summary'>,
  EntryFields
> = {
  experience: {
    title: 'Job title',
    subtitle: 'Company / employer',
    startDate: 'Start date',
    endDate: 'End date (or Present)',
    details: 'Responsibilities and achievements (one per line)',
    detailsMultiline: true,
    extras: [{ key: 'location', label: 'Work location' }],
  },
  education: {
    title: 'Institution / school',
    subtitle: 'Degree / qualification',
  ...
  skills: {
    ...
    details: 'Skills (comma separated)',
    detailsMultiline: true,
  },
  projects: {
    title: 'Project name',
    subtitle: 'Platform (Android / iOS / Web)',
    details: 'What you built and its impact',
    detailsMultiline: true,
    extras: [
  ...
  leadership: {
    ...
    details: 'What you contributed (optional)',
    detailsMultiline: true,
  },
  awards: {
  ...
  references: {
    title: 'Full name',
    subtitle: 'Job title / position',
    details: 'Department and organization',
    detailsMultiline: true,
    extras: [
  ...
  custom: {
    title: 'Item title',
    subtitle: 'Subtitle / organization (optional)',
    startDate: 'Start date (optional)',
    endDate: 'End date (optional)',
...
export type EntryExtras = Partial<Record<ExtraKey, string>> & {
  legacy?: string;
};
